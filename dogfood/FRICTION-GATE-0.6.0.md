...
**Status:** **friction column clear** (f015 Critical–f032 fixed/recovered + locked + pushed 2026-07-17; f013 upgraded + fixed; f017 partial with seams landed and migration tracked; f022–f026 are the Wave 4 completion haul; **f027–f032 are Wave 5's haul** — six findings from five drills, every drill surfaced something real) — wave column: **Wave 4 cut 2026-07-16**, **Wave 5 in progress** (A1, A2, A3, C1, C3 closed; C2 recognition+containment done, unpublish leg pending permission), 6 open  
