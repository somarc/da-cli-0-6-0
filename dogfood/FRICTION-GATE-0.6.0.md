...
**Status:** **friction column clear** (f015 Critical–f029 fixed/recovered + locked + pushed 2026-07-16; f013 upgraded + fixed; f017 partial with seams landed and migration tracked; f022–f026 are the Wave 4 completion haul; **f027–f029 are Wave 5's first-day haul** — every drill so far surfaced a real finding) — wave column: **Wave 4 cut 2026-07-16**, **Wave 5 opened 2026-07-16** (A2 + C3 closed), 6 open  
