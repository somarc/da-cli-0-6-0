...
**Status:** **friction column clear** (f015 Critical–f037 fixed/recovered + locked 2026-07-17; f013 upgraded + fixed; f017 partial with seams landed and migration tracked; f022–f026 are the Wave 4 completion haul; **f027–f037 are Wave 5's haul** — eleven findings, every drill surfaced something real; f033 is the ops-turn catch; **f034–f036 are the drill-matrix completion haul** — the drift guard's destructive recovery, the dead strict-sections off-switch, and the exit-0 approval zombie; **f037 is the shipping-the-site catch** — put blind to missing DA media references, the false-success class) — wave column: **Wave 4 cut 2026-07-16**, **Wave 5 cut 2026-07-17** (C2 orphan-removal rep alone deferred on the Helix-admin delete permission), 6 open
