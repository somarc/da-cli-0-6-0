...
| **5** Failure & recovery injection | **cut** | **Cut 2026-07-17; C2 closed 2026-07-23.** Full drill matrix run: A1–A3, B1–B3, C1–C3, D3, D4 ✅; D1/D2 banked. The final isolated C2 rep proved contentbus → real orphan → guarded dry-run → successful unpreview/unpublish → DA/preview/live absence. Ten findings from the wave (f027–f036), every one fixed/recovered; evidence `dogfood/evidence/wave-5/`. |
...
| C2 | orphan + protected hybrid routes | ✅ **closed 2026-07-23** | Historical recognition/containment/recovery remained valid. Final isolated rep on `proof-v0-6-0-replay`: disposable route established source/preview/live 200, source deletion produced `ownership:orphan` with preview/live 200, dry-run planned unpreview+unpublish only, committed clean succeeded for both Helix deletes, and final source/preview/live/code probes were absent/404. Evidence `c2-closeout-2026-07-23/`; gate behavior remains banked f007/f013. |
...
- Configuration Service access was restored on 2026-07-23. The packaged index inspection commands observe the live config, the certification index path is green, and the isolated C2 rep proved effective Helix preview/live deletion authority plus complete public absence.
